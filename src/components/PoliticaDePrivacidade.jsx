...
export default function PoliticaDePrivacidade() {
  return (
    <>
      ...
      <p>
        A sua privacidade é importante para nós. É política do Planno Finanças
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{" "}
        <a href="https://www.plannofinancas.com.br/">Planno Finanças</a>, e
      ...
      <p>
        ...
        informação que o Planno Finanças oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          ...
          (softwares) do Planno Finanças, de seus fornecedores ou terceiros,
      ...
      <p>Esta política é efetiva a partir de 14 de abril de 2025.</p>
    </>
  );
}
